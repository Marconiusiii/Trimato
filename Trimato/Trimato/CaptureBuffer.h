...
uint64_t TCaptureDeliveries(TCaptureBuffer *ring);
int TCaptureFailure(TCaptureBuffer *ring);
void TCaptureDeviceError(TCaptureBuffer *ring, int32_t status);
int32_t TCaptureDeviceStatus(TCaptureBuffer *ring);
